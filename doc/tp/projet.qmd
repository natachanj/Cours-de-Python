...
# Projet : Prédiction du Risque de Crédit (Machine Learning avec Python)

**Date limite de rendu** : 28 février 2025  
...
[La base de données est disponible ici](https://www.kaggle.com/datasets/laotse/credit-risk-dataset)
...
**Rappel** : Le rendu du TP doit être soumis au plus tard le **28 février 2025**. Veillez à envoyer votre notebook complet à l’adresse : natachayepnga@gmail.com.
