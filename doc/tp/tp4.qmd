...
3. Vérifiez s'il y a des valeurs manquantes et expliquez comment les gérer.
...
où :
- \( P_t \) est le prix de clôture au jour \( t \)
- \( P_{t-1} \) est le prix de clôture du jour précédent

📌 **Questions** :
0. Calculer le rendement de chaque action disponible dans la base
